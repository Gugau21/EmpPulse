...
\begin{itemize}[leftmargin=1.5em]
    ...
    \item \texttt{BonusVacationDaysService} -- Manages bonus vacation days per employee per year.
    \item \texttt{UserRepository}, \texttt{EmployeeRepository}, \texttt{AdminRepository}, \texttt{BonusVacationDaysRepository}.
...
\textbf{Data owned/modified:} \texttt{Leave} table; reads \texttt{Employee}, \texttt{Bonus\_vacation\_days}.
